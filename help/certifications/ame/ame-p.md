...
* 기본 프로그램을 사용하는 이유/시기를 식별합니다.
* 참여 프로그램의 특별한 기능을 식별합니다.
* 이메일 프로그램의 특수 기능을 식별합니다.
* 복제될 수 있는 것을 인식하십시오.
* 사용자 지정 태그의 이점을 식별합니다.
* 채널의 용도를 식별합니다.
* 기간 비용의 중요성에 대해 설명합니다.
* 잠재 고객 스코어를 사용하는 개념을 파악합니다.
* 커뮤니케이션 제한 이해.
* 프로그램 멤버십 및 획득 인식.
