---
title: 비즈니스 전문가 인증
description: Adobe에서 Adobe 비즈니스 전문가의 인증을 받는 방법을 알아봅니다. [!DNL Commerce].
solution: Commerce
role: Developer
...
# Adobe 인증 여정 [!DNL Commerce] 비즈니스 전문가

공인 Adobe 비즈니스 전문가가 되는 방법을 알아봅니다.

## 최소 경험

약 1-3년 정도의 경험을 가지고 있어야 합니다 [!DNL Commerce] 전자 상거래 경험에 대한 풍부한 경험과 이해

다음과 같은 경험이 있어야 합니다.

* 디지털 마케팅: SEO, CMS, 크로스셀링 및 업셀링, Google Analytics 이해, 이메일 템플릿과 같은 판매 기술
* PCI, GDPR, ADA, CAN-SPAM, PSD2와 같은 보안, 규정 준수 및 개인 정보 보호 법
* 옴니채널 및 멀티채널과 같은 판매/마케팅 전략
* 프로젝트 관리, 요구 사항 수집, 통합 흐름, 일반 전자 상거래 법률, 소프트웨어 개발 방법론 및 모니터링 경험
* 비즈니스, 상거래/전자 상거래 및 물류에 대한 이해
* 사용자 정의 가능한 애플리케이션, 클라우드 및 서버 인프라에 대한 기본 이해
* 최신 전자 상거래 용어

또한 다음과 같은 기술을 편리하게 사용할 수 있습니다.

* Adobe [!DNL Commerce] - 버전 2.4
* 분석 및 성능 도구: Google Analytics, 태그 관리자, SWAT, New Relic, 그래픽, Google Lighthouse
...
* 응용 프로그램 설계자/솔루션 설계자/전문가
* 에이전시 관리자/Director/관리자/컨설턴트
* Digital Marketing Director/Manager/개발자
...
을(를) 완료합니다 [온라인 준비 질문](https://scorpion.caveon.com/launchpad/ad-q-e708-readiness-questionnaire-for-adobe-commerce-business-practitioner-expert-exam/ad-q-e708-readiness-questionnaire-for-adobe-commerce-business-practitioner-expert-exam){target="_blank"} 현재 경험이 권장되는 최소 후보 자격과 일치하는지 확인하기 위해 다음을 수행하십시오.

**시험 목표 및 범위**

섹션 1: 핵심 기능/일반 구성(46%)

* Adobe 기능 확인 [!DNL Commerce] Open Source Edition 및 [!DNL Commerce] 에디션
* Adobe의 모든 버전 간 차이 구분 [!DNL Commerce] products
* 고객 요구 사항을 충족하기 위해 제품 유형 및 해당 기능을 활용하는 방법을 결정합니다
* 요구 사항 및 mock up을 해석하여 기본 기능을 충족하는지 확인합니다.
* 관리 패널과 일반적인 기능의 위치에 대한 지식을 보여줍니다
* 가져오기/내보내기 기능 Adobe 시연 [!DNL Commerce] 개체
* 장바구니 및 체크아웃을 기본적으로 구성하는 방법을 이해합니다
* Adobe에서 사용 가능한 기본 운송 방법 평가 [!DNL Commerce] 일반적인 사용 사례에 적용되는 방법
* Adobe을 사용하여 스타일이 지정된 컨텐츠를 만들고 게시하는 방법 이해 [!DNL Commerce] PageBuilder를 포함한 CMS 기능
* 기본 도구를 사용하여 주문 수명 주기를 관리합니다
* 다양한 기여 옵션(기프트 카드, 기프트 포장, 메시지 제공)을 구성할 수 있는 능력을 보여줍니다.
* 트랜잭션 이메일 구성 및 수정
* B2B의 고객 셀프 서비스 및 충성도 프로그램 기본 기능 설명

제2절: 머천다이징(10%)

* 특정 비즈니스 기준을 충족하는 프로모션을 만들고 최종 가격을 결정하는 방법을 보여줍니다.
* 카테고리 및 제품 관리 기능 시연
* 다양한 가격책정 구성 및 최종 가격에 미치는 영향 이해

섹션 3: 디지털 마케팅(4%)

* 기본 기능을 사용하는 SEO에 대한 권장 우수 사례
* Google Analytics 및 BI의 일반적인 지표 평가

섹션 4: 추가 기능 모듈 및 추가 제품(18%)

* B2B 기능 및 일반적인 B2B 시나리오와 관련된 방법 설명
* 비즈니스 요구 사항을 적용하여 MSI를 사용한 솔루션 제안
* Adobe에 BI를 사용하는 방법 및 이점 설명 [!DNL Commerce] 솔루션
* 기본 검색과 LiveSearch 간의 차이 구분
* 비즈니스 요구 사항을 적용하여 B2B 환경에서 세금, 직무 및 면제를 적용하는 방법 결정
* B2B 고객에게 맞춤형 가격을 적용하는 방법 이해
* Adobe 간 차이점 이해 [!DNL Commerce] 기본 제품 및 Adobe Sensei 제품 권장 사항

섹션 5: 시스템 아키텍처(10%)

* 요구 사항을 평가하여 필요한 웹 사이트, 저장소 및 저장소 보기를 파악합니다
* 성능 지표를 식별하고 분석하여 개선
* 외부 시스템을 Adobe과 통합하는 데 사용할 수 있는 방법을 이해합니다 [!DNL Commerce]
* 헤드리스 접근 방식과 기존 방식 구분

제6조: 규정 준수/보안(12%)

* Adobe 보안 방법 시연 [!DNL Commerce] 역할 및 권한을 사용한 데이터 액세스
* 개인 정보 보호 법 및 결제 보안에 대한 규정 준수의 기본 사항 이해
...
* [[!DNL Commerce] 가맹점 설명서](https://docs.magento.com/user-guide/getting-started.html){target="_blank"}
...
* [배송 및 배달](https://docs.magento.com/user-guide/shipping/delivery.html){target="_blank"}
* [주문 관리 및 작업](https://docs.magento.com/user-guide/sales/order-management.html){target="_blank"}
...
* [Adobe용 B2B 소개 [!DNL Commerce]](https://docs.magento.com/user-guide/stores/b2b-basics.html){target="_blank"}
...
* [카테고리 포지셔닝](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/merchants/4-2-arrange-product-categories.html){target="_blank"}
...
* [속성 세트](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/merchants/3-4-product-attribute-sets.html){target="_blank"}
...
* [Business Intelligence 시작(웨비나 기록)](https://business.adobe.com/resources/getting-started-magento-business-intelligence.html){target="_blank"}
...
* [Adobe용 B2B 소개 [!DNL Commerce]](https://docs.magento.com/user-guide/stores/b2b-features.html){target="_blank"}
* [인벤토리 관리](https://docs.magento.com/user-guide/catalog/inventory-management.html){target="_blank"}
...
* [Adobe Sensei Power Magento 제품 Recommendations](https://business.adobe.com/summit/2020/adobe-sensei-powers-magento-product-recommendations.html){target="_blank"}
* [제품 Recommendations 소개](https://docs.magento.com/user-guide/marketing/product-recommendations.html){target="_blank"}

**섹션 5: 시스템 아키텍처**

* [비즈니스 사용자를 위한 상거래 - 사이트, 스토어 및 보기](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/merchants/1-3-apps-scopes-sites-stores.html?lang=en){target="_blank"}
* [비즈니스 사용자를 위한 상거래 - 보기 및 캐시 지우기](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/merchants/1-4-store-views-cache.html?lang=en){target="_blank"}
* [비즈니스 사용자를 위한 상거래 - Storefront](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/merchants/5-1-storefront-experience.html){target="_blank"}
* [스토어 세부 사항](https://docs.magento.com/user-guide/configuration/configuration-basic.html){target="_blank"}
...
* [저장 개인정보 처리방침](https://docs.magento.com/user-guide/stores/privacy-policy.html){target="_blank"}
...
* [국가별 세금 지침](https://docs.magento.com/user-guide/tax/international-tax-guidelines.html){target="_blank"}
