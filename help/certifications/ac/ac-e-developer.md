...
* 작성기
* SSH, 기본 Linux
* Redis, Elasticsearch, SQL, Vanish, RabbitMQ
...
다음을 완료합니다. [온라인 준비 설문지](https://scorpion.caveon.com/launchpad/ad-q-e716-readiness-questionnaire-for-adobe-commerce-developer-expert/ad-q-e716-readiness-questionnaire-for-adobe-commerce-developer-expert){target="_blank"} 현재 경험이 최소 추천 후보 자격과 일치하는지 확인합니다.
...
섹션 2: 데이터베이스 및 EAV 작업(10%)

* EAV 속성 및 속성 세트를 프로그래밍 방식으로 조작
* 데이터베이스 스키마를 확장하는 기능 시연
...
* 새 API를 만들거나 기존 API를 확장하는 기능 시연
* 대기열 시스템을 사용하는 기능 시연
...
* 애플리케이션 서비스에 대한 일반적인 지식과 애플리케이션 서비스 관리 방법 시연(YAML , PHP, MariaDB, Redis, RabbitMQ 등)
...
* [cron 작업 구성](https://devdocs.magento.com/guides/v2.4/config-guide/cli/config-cli-subcommands-cron.html){target="_blank"}
...
* [재고 가져오기 및 내보내기](https://docs.magento.com/user-guide/catalog/inventory-import-export.html){target="_blank"}
...
* [사용자 지정 인덱서 만들기](https://devdocs.magento.com/guides/v2.4/extension-dev-guide/indexing-custom.html){target="_blank"}
* [인덱서 관리](https://devdocs.magento.com/guides/v2.4/config-guide/cli/config-cli-subcommands-index.html){target="_blank"}
* [색인 관리](https://docs.magento.com/user-guide/system/index-management.html){target="_blank"}
* [프론트엔드에서 가격 렌더링](https://devdocs.magento.com/guides/v2.4/ui_comp_guide/howto/price_rendering.html){target="_blank"}
* [Inventory management 소개](https://docs.magento.com/user-guide/catalog/inventory-management.html){target="_blank"}

**섹션 5: 판매 공정 사용자 정의**

* [사용자 지정 체크아웃](https://devdocs.magento.com/guides/v2.4/howdoi/checkout/checkout_overview.html){target="_blank"}
...
* [사용자 정의 운송 회사 추가](https://devdocs.magento.com/guides/v2.4/howdoi/checkout/checkout-add-custom-carrier.html){target="_blank"}
* [사용자 정의 운송 회사 유효성 검사 추가](https://devdocs.magento.com/guides/v2.4/howdoi/checkout/checkout_carrier.html){target="_blank"}
* [체크아웃 단계 보기 사용자 정의](https://devdocs.magento.com/guides/v2.4/howdoi/checkout/checkout_customize.html){target="_blank"}
* [체크아웃 합계를 위한 정렬 순서](https://docs.magento.com/user-guide/sales/checkout-totals-sort-order.html){target="_blank"}
