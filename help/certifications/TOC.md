...
user-guide-description: Adobe의  [!DNL Experience Cloud] 인증에 대해 알아봅니다. 인증을 받으면 무엇을 할 수 있는지 알아봅니다.
...
+ 솔루션별 기술 인증 {#technical-certifications}
   ...
   + Adobe [!DNL Commerce] {#ac}
      + [Commerce 개요](/help/certifications/ac/ac-overview.md)
      + 전문가 {#ac-professional}
   ...
   + Adobe [!DNL Workfront] {#aw}
      ...
      + 전문가 {#aw-professional}
         ...
         + [개발자(핵심)](/help/certifications/aw/aw-core-p-developer-23-12.md)
      + 전문가 {#aw-expert}
