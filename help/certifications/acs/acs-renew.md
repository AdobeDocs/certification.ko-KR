...
+++Adobe [!DNL Campaign Standard] 비즈니스 전문가의 갱신
...
* 에서 채널(푸시 알림, 이메일, SMS, DM, 인앱)을 식별합니다 [!DNL Campaign Standard]
...
* 다양한 사용 사례에서 API 인터페이스를 활용하도록 프로세스를 적용합니다
* 프로세스를 적용하여 사용자 지정 리소스 만들기
* 데이터 모델 모범 사례를 할당할 올바른 전략 결정
* 가져오기 또는 내보내기 워크플로우를 사용하는 방법을 추천합니다

제2절: Campaign Management (40%)

* 시나리오가 발생하면 이벤트 트리거를 식별합니다
* 조정 프로세스 설명
* 게재에 대한 사용자 지정 보고서 구성
* 통신 채널을 구성하는 올바른 방법 결정(실시간 및 비실시간)
* 랜딩 페이지를 구성하고 개인화하는 프로세스를 설명합니다
* 시나리오가 제공되면 워크플로우 오류 및 통합 문제 해결
* 새로운 Campaign 기능에 대한 사용 사례 식별

섹션 3: 관리(30%)

* 개인 정보 관리 구성
* 하위 도메인을 Adobe(브랜드 구성 포함)에 위임하는 활동 목록 식별
* Campaign 컨트롤 패널 기능 설명
* 외부 SFTP에 액세스하기 위한 Campaign 구성 분석
* Adobe Campaign과 더 광범위한 Adobe Experience Cloud 간의 통합의 이점 설명
* 프로세스를 적용하여 구성 패키지를 가져오고 내보냅니다
* 사용자 액세스 및 권한 또는 조직 구조를 관리하는 프로세스를 권장합니다
...
Adobe 인증에 대해 질문이 있습니까? [문의](mailto:certif@adobe.com){target="_blank"}.
