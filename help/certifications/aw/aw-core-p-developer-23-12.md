...
>[!NOTE]
>
>**사용 가능한 새 과정:** 다음 [Adobe Workfront 핵심 개발자 - 전문 교육 과정](https://app.rockinfo.com/courses/231) 주요 개념에 대한 설명, 실습 시연, 지식 점검 등이 수록되어 있다. _로그인하라는 메시지가 표시되면 Adobe ID을 사용합니다._
